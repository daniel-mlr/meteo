...
set shortmess=aoO
badd +9 ~/mooc/freecodecamp/projets/meteo/index.html
badd +2 ~/mooc/freecodecamp/projets/meteo/css/style.css
badd +0 ~/mooc/freecodecamp/projets/meteo/js/script.js
argglobal
silent! argdel *
argadd index.html
set stal=2
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 56 - ((25 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
56
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 57 - ((13 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
57
